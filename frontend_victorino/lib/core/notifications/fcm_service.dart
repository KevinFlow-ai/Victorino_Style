...
/// la notificación nativamente desde el payload "notification" sin WorkManager.
...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  debugPrint('[FCM Background] titulo=${message.data["titulo"]} | tipo=${message.data["tipo"]}');
}
...
class FcmService {
  ...
  static Future<void> inicializar() async {
    ...
    // Tap en notificación con la app CERRADA.

...
// Esto es para generar una tarjeta de una sola notificación en la bandeja.
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              // Aquí se muestra el icono según el tipo.
              ...
              // Este es un punto indicador si no está leída.
              if (!esLeida)
                Padding(

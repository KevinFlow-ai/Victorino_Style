...
class Notificacion {
  ...
  // Tipo del string tal como llega del backend: "RECORDATORIO_24H", "CONFIRMACION_RESERVA", etc.
  final String tipo;

  final bool enviadaPush;
  final DateTime fechaCreacion;

  // null si la notificación no ha sido leída todavía.
  final DateTime? fechaLectura;

  // null si la notificación no está asociada a una cita concreta.
  final int? idCita;

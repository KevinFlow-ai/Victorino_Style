-- ======================================================================================
-- ============== SEED TFG VICTORINO STYLE (2025/2026) =====================
-- ======================================================================================
--
-- Genera datos coherentes y realistas para probar de extremo a extremo la app:
--
--   - 1 peluquería con horario semanal (lun–vie 10:00–18:00, sáb 10:00–16:00)
--   - 3 empleados (1 admin que también atiende + 2 peluqueros) con descansos distintos
--   - 4 servicios con duraciones múltiplos de 15 min (15, 30, 45, 90)
--   - 15 festivos Madrid 2026 + cierre anual en agosto
--   - 50 clientes (10 demo con misma contraseña + 40 con contraseña única por cliente)
--   - ~1000 citas entre el 01/03/2026 y el 20/06/2026, sin solapes, sin domingos,
--     sin festivos, respetando descansos. Distribuidas por rangos:
--       · 01 mar – 30 abr  : 15–20 citas/día (rango histórico, estados terminales)
--       · 01 may – 24 may  : 8–10  citas/día (rango histórico, estados terminales)
--       · 25 may – 20 jun  : 4–6   citas/día (rango futuro, estados CONFIRMADA / CANCELADA_*)
--   - Notificaciones coherentes por cada cita: confirmación al cliente, aviso al
--     empleado, cancelaciones según estado y recordatorios 24h cuando corresponde.
--
-- Las credenciales (correo + contraseña en texto plano) están al final del archivo.
-- ======================================================================================
